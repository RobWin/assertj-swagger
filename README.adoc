...
If you are using the https://github.com/spring-projects/spring-framework[spring-framework] and https://github.com/springfox/springfox[springfox], you can validate the Swagger JSON output against your design-first Swagger specification.
